...
<body>
    ...
    <div class="container">
      ...
      <div class="row g-4">
        <div class="col-md-6 col-lg-3" data-aos="zoom-in">
          <div class="card zone-card h-100 shadow-sm border-0">
            <img
              ...
              class="card-img-top" alt="E-commerce" />
            <div class="card-body text-center">
              ...
              <a href="<?= BASE_URL ?>login" class="btn btn-primary rounded-pill">Découvrir</a>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="200">
          <div class="card zone-card h-100 shadow-sm border-0">
            <img src="https://gandaimmobilier.com/wp-content/uploads/2018/05/vente-ico-1.png" class="card-img-top"
              alt="Immobilier" />
            <div class="card-body text-center">
        ...
        <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="400">
          <div class="card zone-card h-100 shadow-sm border-0">
            <img src="https://weezevent.com/wp-content/uploads/2023/03/30113932/activite-association.jpg"
        ...
        <div class="col-md-6 col-lg-3" data-aos="zoom-in" data-aos-delay="600">
          <div class="card zone-card h-100 shadow-sm border-0">
            <img src="https://i.ytimg.com/vi/asqojHCK8cU/maxresdefault.jpg" class="card-img-top" alt="Événements" />
            <div class="card-body text-center">
    ...
    <div class="container">
      <div class="row align-items-center g-5">
        ...
        <div class="col-lg-6 text-center" data-aos="fade-left">
          <img src="https://images.unsplash.com/photo-1521737604893-d14cc237f11d" class="img-fluid rounded-4 shadow"
  ...
  <section class="py-5 bg-primary text-white text-center">
    <div class="container">
      ...
      <a href="<?= BASE_URL ?>inscription" class="btn btn-light btn-lg rounded-pill px-5" data-aos="zoom-in">
